...
<cffunction name="cfReport" hint="This tag is the interface to CFML Report Engine. This class provides the new report features. If the tag attribute template is not, then all the work is passed to the parent class OldReportTag.">
	...
	<cfReport title="#arguments.title#"
		type="#arguments.type#"
...
<cffunction name="cfdocumentsection" hint="DocumentSectionTag will render/export its own section of html content and getting resources from its parent tag. it is like a mini CFDocument tag">
	<cfargument name="margintop" required="false" default="">
	<cfargument name="marginbottom" required="false" default="">
	<cfargument name="marginleft" required="false" default="">
	<cfargument name="marginright" required="false" default="">
	...
	<cfdocumentsection margintop="#arguments.margintop#"
		marginbottom="#arguments.marginbottom#"
		marginleft="#arguments.marginleft#"
		marginright="#arguments.marginright#"
		src="#arguments.src#"
...
<cffunction name="cfgrid" hint="CFGRID tag">
	...
	<cfgrid passthrough="#arguments.passthrough#"
		attributecollection="#arguments.attributecollection#"
		name="#arguments.name#"
		label="#arguments.label#"
...
<cffunction name="cfgridcolumn" hint="CFGRIDCOLUMN tag">
	<cfargument name="passthrough" required="false" default="">
	<cfargument name="attributecollection" required="false" default="">
	<cfargument name="name" required="true" default="">
	<cfargument name="mask" required="false" default="">
	...
	<cfargument name="type" required="false" default="">
	<cfargument name="headerFont" required="false" default="">
	<cfargument name="headerFontSize" required="false" default="">
	<cfargument name="headerItalic" required="false" default="">
	<cfargument name="headerBold" required="false" default="">
	<cfargument name="headerTextColor" required="false" default="">
	<cfargument name="dataAlign" required="false" default="">
	<cfargument name="headerAlign" required="false" default="">
	<cfargument name="numberFormat" required="false" default="">
	<cfargument name="values" required="false" default="">
	<cfargument name="valuesDisplay" required="false" default="">
	<cfargument name="valuesDelimiter" required="false" default="">
	
	<cfgridcolumn passthrough="#arguments.passthrough#"
		attributecollection="#arguments.attributecollection#"
		name="#arguments.name#"
		mask="#arguments.mask#"
		...
		type="#arguments.type#"
		headerFont="#arguments.headerFont#"
		headerFontSize="#arguments.headerFontSize#"
		headerItalic="#arguments.headerItalic#"
		headerBold="#arguments.headerBold#"
		headerTextColor="#arguments.headerTextColor#"
		dataAlign="#arguments.dataAlign#"
		headerAlign="#arguments.headerAlign#"
		numberFormat="#arguments.numberFormat#"
		values="#arguments.values#"
		valuesDisplay="#arguments.valuesDisplay#"
		valuesDelimiter="#arguments.valuesDelimiter#"> 	
	</cfgridcolumn>
</cffunction>		



<cffunction name="cfgridrow" hint="CFGRIDROW tag">
	<cfargument name="passthrough" required="false" default="">
	<cfargument name="attributecollection" required="false" default="">
	<cfargument name="data" required="true" default="">
	
	<cfgridrow passthrough="#arguments.passthrough#"
		attributecollection="#arguments.attributecollection#"
		data="#arguments.data#"> 	
	</cfgridrow>
</cffunction>		
...
<cffunction name="cfhttpparam" hint="cfhttpparam is used to specify the parameters necessary to build a cfhttp request. Required for cfhttp POST operations, optional for others">
	<cfargument name="name" required="true" default="">
	<cfargument name="type" required="true" default="">
	<cfargument name="value" required="false" default="">
	<cfargument name="file" required="false" default="">
	<cfargument name="encoded" required="false" default="">
	<cfargument name="mimeType" required="false" default="">
	
	<cfhttpparam name="#arguments.name#"
		type="#arguments.type#"
		value="#arguments.value#"
		file="#arguments.file#"
...
<cffunction name="cfmailparam" hint="Can either attach a file or add a header to a message. It is nested within a cfmail tag. You can use more than one cfmailparam tag within a cfmail tag.">
	<cfargument name="name" required="false" default="">
	<cfargument name="value" required="false" default="">
	<cfargument name="file" required="false" default="">
	<cfargument name="type" required="false" default="">
	<cfargument name="contentID" required="false" default="">
	<cfargument name="disposition" required="false" default="">
	
	<cfmailparam name="#arguments.name#"
		value="#arguments.value#"
		file="#arguments.file#"
		type="#arguments.type#"
...
<cffunction name="cfmailpart" hint="Specify a part mail of a mail message for CFMail tag.">
	<cfargument name="charset" required="false" default="">
	<cfargument name="type" required="true" default="">
	<cfargument name="wrapText" required="false" default="">
	
	<cfmailpart charset="#arguments.charset#"
		type="#arguments.type#"
		wrapText="#arguments.wrapText#"> 	
	</cfmailpart>
</cffunction>		
